...
% sneaky keywords for ATS on things that are implied by my other listed skills
 {\fontsize{0.1}{0.1}\selectfont \texttransparent{1}{ HTML, CSS, JSON, YAML, XML, PostgreSQL}}\\
...
\hspace*{32mm}Celery, nginx, Redis, Linux, CircleCI, Jenkins, Github Actions, Jest, REST
 {\fontsize{0.1}{0.1}\selectfont \texttransparent{1}{ Unix, Pyramid, RabbitMQ, React Hooks, Ansible, Tilt }}
