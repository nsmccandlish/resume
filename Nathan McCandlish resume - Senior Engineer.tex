...
\multirow{ 2}{*}{\huge \textbf {Nathan McCandlish}} & \hfill \\ % email here - wait can you
& \hfill \url{linkedin.com/in/nsmccandlish}\\ % yep idc it's a real link
\large{Senior Software Engineer}& \hfill % phone here
\end{tabular}
}
\begin{resume}
%%%%%
